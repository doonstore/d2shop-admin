                ...
                child: Column(
                  ...
                  children: [
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (dataList.length > 0) {
                          return DropdownButtonFormField<String>(
                            decoration:
                                InputDecoration(labelText: 'Choose Category'),
                            items: dataList
                                .map((e) =>
                    ...
                    if (category != null)
                      FutureBuilder(
                        future:
                            FirestoreServices().fetchSubCategories(category),
                    ...
                    SizedBox(height: 10),
                    TextFormField(
                      decoration: Utils.inputDecoration("Name of the product",
                          helper: "Amul Milk"),
                      validator: (value) =>
                    ...
                    TextFormField(
                      decoration: Utils.inputDecoration(
                          "Price of the product (Numeric Value)",
                          helper: "150"),
                    ...
                    SizedBox(height: 10),
                    TextFormField(
                      decoration: Utils.inputDecoration("Quantity Unit",
                          helper: 'G / KG / L / ML'),
                      validator: (value) =>
                          value.isEmpty ? 'This field is required.' : null,
                    ...
                    !loading
                        ? Align(
                            ...
                            child: CustomButton(
                                onTap: submit, text: 'Add New Product'),
                          )
                        : Align(
