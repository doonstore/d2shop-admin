                ...
                child: Column(
                  ...
                  children: [
                    TextFormField(
                      ...
                      decoration:
                          Utils.inputDecoration("Promo Code", helper: "MILK50"),
                      validator: (value) =>
                    ...
                    SizedBox(height: 10),
                    TextFormField(
                      decoration: Utils.inputDecoration("Promotional Message",
                          helper: "Get 50% off"),
                      validator: (value) =>
                          value.isEmpty ? 'This field is required.' : null,
                    ...
                    TextFormField(
                      initialValue: '1',
                      decoration:
                          Utils.inputDecoration("Limit (Numeric Value)"),
                      validator: (value) =>
                          value.isEmpty ? 'This field is required.' : null,
                    ...
                    !loading
                        ? Align(
                            ...
                            child: CustomButton(
                                onTap: submit, text: 'Add New Coupon'),
                          )
                        : Align(
